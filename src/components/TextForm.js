...
export default function TextForm(props) {
    ...
    const handleCopy=()=>{
        ...
        // document.getSelection().removeAllRanges();//removes selected content from preview
    ...
    return (
        ...
        <div className="container"  >
            ...
            <button disabled={text.length===0} className="btn btn-primary me-2 mb-2" onClick={handleUpClick}>Convert to Upper case</button>
            <button disabled={text.length===0} className="btn btn-primary me-2 mb-2" onClick={handleLoClick}>Convert to Lower case</button>
            <button disabled={text.length===0} className="btn btn-primary me-2 mb-2" onClick={handleClearClick}>Clear</button>
            <button disabled={text.length===0} className="btn btn-primary me-2 mb-2" id="copy-btn" onClick={handleCopy}>Copy Text</button>
        </div>
